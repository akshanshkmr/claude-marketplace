...
- **Mean/SD in text**: use `mean X (SD Y)` format in running text — labels must appear: `mean 45.3 (SD 12.7)`. In table cells omit labels (header carries them): `45.3 (12.7)`. A lone mean without SD is incomplete — query. `ctx`
